<div class="bg-white">
    <div class="grid lg:grid-cols-2 md:grid-cols-1 gap-2">
        <div class="">
            <img class="rounded-full h-full" src="https://www.posindonesia.co.id/en/artikel/image/Umrq07UinRfsf5i5.jpg" alt="">
        </div>
        <div class="">
            <div class="p-3 border rounded-xl shadow-xl bg-orange-500">
                <form action="src/function/proses_login.php" method="post">
                    ...
                    <div>
                        <button type="submit" class="btn btn-primary bg-blue-500 hover:bg-blue-600" value="login"> Login </button>
                    </div>
                </form>
            </div>
        </div>
