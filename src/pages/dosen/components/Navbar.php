<nav class="navbar  bg-white shadow-lg fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="_dashboard-dosen.php"><img class="w-32" src="../../assets/img/logo.png" alt=""> Dashboard Dosen</a>
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item hover:bg-gray-200 p-2">
                        <a class="nav-link active" aria-current="page" href="_dashboard-dosen.php"><i class="fa-solid fa-house-chimney"></i> Home</a>
                    </li>
                    <li class="nav-item hover:bg-gray-200 p-2">
                        <a class="nav-link" href="_table-dosen.php"><i class="fa-solid fa-table"></i> Table</a>
                    </li>
                    <li class="nav-item hover:bg-gray-200 p-2">
