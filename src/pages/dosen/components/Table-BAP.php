                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Edit BAP - <?php echo $row['kode_matakuliah']; ?></h1>
                                ...
                                <form method="POST" action="../../function/Proses_UpdateMatakuliah.php?kode_matakuliah=<?php echo $row['kode_matakuliah']; ?>">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="kode_matakuliah" class="form-label">Kode BAP</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="nama_matakuliah" class="form-label">Nama BAP</label>
